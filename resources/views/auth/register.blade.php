...
<head>
    ...
    <meta property="og:image" content="../dolab.dexignzone.com/xhtml/social-image.png">
                                ...
                                <div class="auth-form">
                                    <div class="text-center mb-3">
                                            <div class="logo">
                                                ...
                                                <svg class="brand-title ms-2" width="124" height="33"
                                                    viewBox="0 0 124 33" fill="none"
                           ...
                           value="{{ old('email') }}"
                               ...
                               value="{{ old('phone') }}" placeholder="phone" required>
                                    ...
                                    <div class="new-account mt-3">
                                        <p class="text-white">Already have an account? <a href="{{ route('login') }}" class="fw-semibold">Login</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
