                    ...
                    <div class="card-body p-4">
                        <form action="{{ Url('account/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input value="{{old('account_number')}}" type="text" class="form-control" placeholder="Account Number"
                                            name="account_number">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input value="{{old('name')}}" type="text" class="form-control" placeholder="Account Number"
                                            name="name">
                                        <label>
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input value="{{old('national_id')}}" type="text" class="form-control" placeholder="Phone" name="national_id">
                                        <label>
                            ...
                            <div class="row g-3 mt-2">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input value="{{old('date_of_birth')}}" type="date" class="form-control" name="date_of_birth">
                                        <label>
                            ...
                            <div class="row g-3 mt-2">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input value="{{old('balance')}}" type="text" class="form-control" placeholder="Balance" name="balance">
                                        <label>
