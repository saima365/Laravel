                                        ...
                                        {{-- <tr>
                                            ...
                                            <td class="whitesp-no p-0">
                                                <div class="d-flex py-sm-3 py-1 align-items-center">
                                                    <span class=" me-3">
                                                        <img src="./images/profile/small/pic16.jpg" alt=""
                                                            width="50" class="rounded-3 img-history">
                                                    </span>
                                                    <div>
                                        ...
                                        @foreach ($transactions as $transaction)
                                            <tr>
                                                ...
                                                <td class="whitesp-no p-0">
                                                    <div class="d-flex py-sm-3 py-1 align-items-center">
                                                        <span class="me-3">
                                                            <img src="{{ asset('storage/' . ($transaction->customer->img ?? 'default.png')) }}"
