                        ...
                        <div class="row">
                                    ...
                                    <div class="card-header border-0 flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="round" id="dzNewSeries">
                                                <input type="checkbox" id="checkbox" name="balance_summary"
                                                    value="monthly">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="card  pia-chart">
                                    ...
                                    <div
                                        class="card-body d-flex align-items-center justify-content-center custome-tooltip">
                                ...
                                <div class="col-xl-12 col-lg-6">
                                    <div class="card bg-transparent contacts mb-1">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Add Person
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <label for="PersonPosition"
                                                                    class="form-label d-block">Enter Position</label>
                                        ...
                                        <div class="card-body loadmore-content dz-scroll recent-activity-wrapper px-3  py-3"
                                            ...
                                            <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                                <span class="me-3 me-lg-2">
                                                    <img src="assets/images/profile/small/pic2.jpg" alt=""
                                                        width="50">
                                                </span>
                                                <div class="ms-2">
                                                    <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Evans
                                                            John</a></h6>
